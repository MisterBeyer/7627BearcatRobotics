...
public class SwerveModule {
  ...
  public SwerveModuleState getState() {
    return new SwerveModuleState(currentDrive, new Rotation2d(m_turningEncoder.get()));
  }
...
//        m_driveMotor.setVoltage(driveOutput + driveFeedforward);
        m_driveMotor.set(ControlMode.PercentOutput, driveOutput/2);
